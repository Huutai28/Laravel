								...
								<table id="sampleTable" class="table table-bordered" style="margin-top:20px;">				
									...
									<tbody>
										...
										<tr>
											...
											<td>{{number_format($prod->prod_price)}} VND</td>
											<td>
											...
											<td>
												...
												<a href="{{asset('admin/product/delete/'.$prod->prod_id)}}" onclick="return confirm('Bạn có chắc chắn muốn xóa?')" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i> Xóa</a>
											</td>
										</tr>
										@endforeach
									</tbody>
