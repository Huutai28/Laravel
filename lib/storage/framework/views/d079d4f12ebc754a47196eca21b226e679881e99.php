	...
	<div class="row">
		<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
			<div class="login-panel panel panel-default">
				<div class="panel-heading">Đăng Nhập Quản Trị Viên</div>
				<div class="panel-body">
					<form role="form" method="POST" action="">
						<fieldset>
							<?php echo $__env->make('errors.note', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
							<div class="form-group">
								<input class="form-control" placeholder="Nhập E-mail" name="email" type="email" value="<?php echo e(old('email')); ?>" autofocus="">
							</div>
							<div class="form-group">
...
<?php /**PATH C:\xampp\htdocs\laravel\lib\resources\views/backend/login.blade.php ENDPATH**/ ?>