...
<head>
	...
	<base href="<?php echo e(asset('public/layout/frontend')); ?>/">
		...
		<div class="container">
			<div class="row">
				<div id="logo" class="col-md-3 col-sm-12 col-xs-12">
					<h1>
						<a href="<?php echo e(asset('/')); ?>"><img src="img/home/logo.png"></a>						
				...
				<div id="search" class="col-md-7 col-sm-12 col-xs-12">
					<form method="GET" action="<?php echo e(asset('search/')); ?>">
				...
				<div id="sidebar" class="col-md-3">
					<nav id="menu">
						<ul>
							...
							<li class="menu-item"><a href="<?php echo e(asset('category/'.$cate->cate_id.'/'.$cate->cate_slug.'.html')); ?>" title=""><?php echo e($cate->cate_name); ?></a></li>
...
</html><?php /**PATH C:\xampp\htdocs\laravel\lib\resources\views/frontend/master.blade.php ENDPATH**/ ?>